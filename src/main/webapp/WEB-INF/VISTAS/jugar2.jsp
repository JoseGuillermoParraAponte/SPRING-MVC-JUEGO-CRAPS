...
<body>
	...
	<div id="contenedor_principal">
		...
		<div class="contenedor_arriba">
			...
			<div
				style="background: #f77c0a; float: left; width: 100px; height: 40px; margin: 10px; text-align: center">Línea
				de pase: ${juego.lineaDePase}</div>
			<div
				style="background: #f77c0a; float: left; width: 100px; height: 40px; margin: 10px; text-align: center">Tiro
				de salida: ${juego.tiroDeSalida}</div>
		</div>
		<hr />
